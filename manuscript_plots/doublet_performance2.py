...
def _format_figure(f, ax_irf, ax_pax, ax_spectra, grid):
    ...
    ax_irf.text(0.9, 0.7, 'A', fontsize=10, weight='bold', horizontalalignment='center',
       transform=ax_irf.transAxes)
    ax_irf.text(0.03, 0.65, 'Model\nPhotoemission', fontsize=9, horizontalalignment='left',
       transform=ax_irf.transAxes)
    ...
    ax_spectra.text(0.1, 0.76, 'C', fontsize=10, weight='bold', horizontalalignment='center',
